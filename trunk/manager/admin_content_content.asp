...
<%
	dim PageTitle, contact_rs, action, root_rs
	dim tid, title, content, src, tm, hit, url, titlecolor, picurl, author, istj, isflash, ispic
	PageTitle = "内容添加"
...
<table class="mytable" border="0" cellspacing="0" cellpadding="0">
	...
	<tr class="table_title">
    	<td colspan="3"><%=iif(action="add", "添加文章", "修改文章")%></td>
    </tr>
