...
<table class="mytable" border="0" cellspacing="0" cellpadding="0">
	...
	<tr class="table_ipt_tr">
		<td width="19%" style="text-align: right; font-weight: bold;">录入时间：</td>
        <td width="3%">&nbsp;</td>
        <td width="78%">
            <input class="ipt" type="text" name="time" id="time" value="<%=iif(action = "edit", tm, "")%>" />
            <span class="hint">*请输入文章录入时间，留空为现在时间</span>
        </td>
	</tr>
    <tr class="table_ipt_tr">
