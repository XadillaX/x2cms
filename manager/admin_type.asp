        ...
        function(data){
            ...
            $("#edit_type").dialog({
                ...
                buttons:[{
                    ...
                    iconCls:'icon-ok',
                    handler:function(){
                        setTimeout("do_type_edit_submit()", 0);
                    }
                },{
                    text:'取消',
                    handler:function(){
...
function do_type_edit_page_submit()
{
        ...
        function(data){
            ...
            $("#edit_type_page").dialog({
                ...
                buttons:[{
                    ...
                    iconCls:'icon-ok',
                    handler:function(){
                        setTimeout("do_type_edit_page_submit()", 0);
                    }
                },{
                    text:'取消',
                    handler:function(){
            ...
            $("#loading_hint").hide("normal");
			$("#edit_type_page").dialog("move", { top: 0 });
        }
    );
}

function do_type_del_submit()
{
...
function type_del(tid, type, count)
{
    ...
    $("#del_type").dialog({
        ...
        buttons:[{
            ...
            iconCls:'icon-ok',
            handler:function(){
                setTimeout("do_type_del_submit()", 0);
            }
        },{
            text:'取消',
            handler:function(){
...
<table class="mytable" border="0" cellspacing="0" cellpadding="0">
    <tr class="table_title">
        ...
        <td width="30%" valign="middle">栏目名称</td>
        <td width="20%" valign="middle">编辑 / 删除</td>
